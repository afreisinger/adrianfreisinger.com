---
title: A Telegram bot that provides real-time weather information
description: 'Automate weather retrieval with real-time conditions, multi-day and hourly forecasts, and weather alerts — all accessible via Telegram commands, OpenClaw or a CLI tool.'
featured: true
date: 2026-04-02
slug: /blog/weather-bot/
tags:
  - python
  - automation
  - telegram
...
| `CONFIG_PATH`         | _(Optional)_ Custom config file path |
