...
We create classes for the database entities. The objects of these classes, are mapped to the corresponding database entity. For example, the object of a _User_ class would represent a row in the table.
